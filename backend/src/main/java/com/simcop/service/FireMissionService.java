...
public class FireMissionService {
    ...
    @Transactional
    public FireMission assignArtillery(String id, String artilleryId, String projectileType, Integer charge) {
        FireMission mission = repository.findById(id)
                .orElseThrow(() -> new RuntimeException("Mission not found: " + id));
        ...
        mission.setProjectileType(projectileType != null ? projectileType : "HE");
        mission.setCharge(charge != null ? charge : 1);
