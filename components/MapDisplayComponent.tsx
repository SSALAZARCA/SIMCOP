...
export const MapDisplayComponent: React.FC<MapDisplayProps> = ({
  ...
  // Delegar el renderizado de unidades al hook especializado
  useUnitLayer(mapRef.current, filteredUnits, selectedEntity, onSelectEntityOnMap, unitLayerRef as React.MutableRefObject<L.FeatureGroup<any> | L.MarkerClusterGroup>);
