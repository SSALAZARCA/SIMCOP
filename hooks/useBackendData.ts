...
export const useBackendData = (): UseSimulatedDataReturn => {
  ...
  return {
    ...
    sendQ5ReportViaTelegram: sendQ5ReportViaTelegram as any,
    ...
    processSpotReport,
    addOperationsOrder,
    updateOperationsOrder: updateOperationsOrder as any,
    publishOperationsOrder: publishOperationsOrder as any,
