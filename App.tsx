...
const App: React.FC = () => {
  ...
  const handleApproveAo = useCallback(async () => {
    ...
    if (aoDrawingUnitId) {
      ...
      // General AOI for Analysis
      eventBus.publish('finalizeAoiLayer', pendingAoiGeoJson);
      eventBus.publish('approveGeneralAoi', pendingAoiGeoJson);
      setPendingAoiGeoJson(null);
      setAoiDrawingModeActive(false);
      eventBus.publish('deactivateAoiDrawingMode');
    }
  ...
  return (
    <div className="flex flex-col h-screen bg-[#0d1117] text-gray-100 antialiased font-sans selection:bg-blue-500/30">
      ...
      {aoiDrawingModeActive && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 z-[1000] pointer-events-auto">
